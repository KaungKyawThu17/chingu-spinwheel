                            ...
                            <div>
                                ...
                                @elseif ($type === 'select')
                                    <select name="{{ $key }}"
                                        ...
                                        @endforeach
                                        @if ($hasOther)
                                            <option value="other" {{ old($key) == 'other' ? 'selected' : '' }}>Other
                                            </option>
                                        @endif
                                    </select>
                                    @if ($hasOther)
                                        <input id="{{ $otherKey }}" data-other-input="{{ $key }}"
                                            type="text" name="{{ $otherKey }}" value="{{ old($otherKey) }}"
                    ...
                    @else
                        ...
                        <div>
                            ...
                            <select name="age"
                                ...
                                <option value="35+" {{ old('age') == '35+' ? 'selected' : '' }}>၃၅ နှင့်အထက်
                                </option>
                            </select>
                            @error('age')
                                <p class="text-red-600 text-xs sm:text-sm mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <select id="job_title" name="job_title"
                                ...
                                <option value="office" {{ old('job_title') == 'office' ? 'selected' : '' }}>
                                    ရုံးဝန်ထမ်း
                                </option>
                                <option value="business" {{ old('job_title') == 'business' ? 'selected' : '' }}>
                                    စီးပွားရေးပိုင်ရှင်</option>
                                <option value="freelancer" {{ old('job_title') == 'freelancer' ? 'selected' : '' }}>
                                    Freelancer
                                </option>
                        ...
                        <div>
                            ...
                            <div class="mt-1 space-y-1 text-sm sm:text-base">
                                <label class="flex items-start gap-2">
                                    <input type="radio" class='mt-1' name="drink_meal_important" required
                                        value="very" {{ old('drink_meal_important') == 'very' ? 'checked' : '' }}>
                                    <span class="leading-tight">အလွန်အရေးကြီးပါတယ် - အမြဲတမ်း အစားအစာနဲ့
                                        တွဲသောက်တတ်ပါသည်</span>
                                </label>
                                <label class="flex items-start gap-2">
                                    <input type="radio" class='mt-1' name="drink_meal_important"
                                        value="somewhat"
                                        {{ old('drink_meal_important') == 'somewhat' ? 'checked' : '' }}>
                                    <span class="leading-tight">ပုံမှန် အရေးကြီးပါတယ် - တစ်ခါတရံ
                                        တွဲသောက်တတ်ပါသည်</span>
                                </label>
                                <label class="flex items-start gap-2">
                                    <input type="radio" class='mt-1'name="drink_meal_important"
                                    ...
                                    <span class="leading-tight">အရေးမကြီးပါဘူး - အစားအစာမပါဘဲ ဆိုဂျူးကို
                                        သောက်တတ်ပါသည်</span>
                                </label>
                            </div>
